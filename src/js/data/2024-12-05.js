dataSetVersion = "2024-12-05"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].options = [
  ...
  {
    name: "Remove Unobtainable",
    key: "unobtainable",
    tooltip: "Check this to remove all operators that are locked to specific gamemodes (reserve operators, elite operators from Integrated Strategies, etc).",
    checked: false
  }
];
...
dataSet[dataSetVersion].characterData = [
  ...
  {
    name: "Reserve Operator - Defender",
    img: "a9yvZ7H.png",
    opts: {
      class: ["defender"],
      rarity: ["3star", "4star"],
  ...
  {
    name: "Reserve Operator - Supporter",
    img: "DosXdRa.png",
    opts: {
      class: ["supporter"],
      rarity: ["3star", "4star"],
  ...
  {
    name: "Reserve Operator - Specialist",
    img: "yY5lirb.png",
    opts: {
      class: ["specialist"],
      rarity: ["3star", "4star"],
